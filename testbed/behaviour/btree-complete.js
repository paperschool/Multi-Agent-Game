 ...
 * Version: 1.0.3
 */
!function(e){if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.BehaviourTree=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"Base":[function(_dereq_,module,exports){
...
BehaviourTree = _dereq_('../lib/base').extend({
  ...
  step: function() {
    if (this._started) {
      throw new Error('the BehaviourTree "' + this.title + '" did call step but one Task did not finish on last call of step.');
    }
    this._started = true;
    var node = BehaviourTree.getNode(this._rootNode);
...
BehaviourTree._registeredNodes = {};
BehaviourTree.register = function(name, node) {
...
BehaviourTree.getNode = function(name) {
  var node = name instanceof BehaviourTree.Node ? name : this._registeredNodes[name];
  if (!node) {
...
var BehaviourTree = _dereq_('./Behaviour_tree');
...
module.exports = _dereq_('./node').extend({
  ...
  _run: function() {
    var node = BehaviourTree.getNode(this.children[this._actualTask]);
...
},{"./Behaviour_tree":5,"./node":10}],7:[function(_dereq_,module,exports){
...
module.exports = _dereq_('./node').extend({
  constructor: function(config) {
    ...
    this.base(config);
    if (this.node) {
      this.node = BehaviourTree.getNode(this.node);
    }
  },
  setNode: function(node) {
    this.node = BehaviourTree.getNode(node);
  },
  start: function() {
...
},{"./Behaviour_tree":5,"./node":10}],8:[function(_dereq_,module,exports){
var BehaviourTree = _dereq_('./Behaviour_tree');
BehaviourTree.Node = _dereq_('./node');
BehaviourTree.Task = _dereq_('./task');
BehaviourTree.BranchNode = _dereq_('./branch_node');
BehaviourTree.Priority = _dereq_('./priority');
BehaviourTree.Sequence = _dereq_('./sequence');
BehaviourTree.Random = _dereq_('./random');

BehaviourTree.Decorator = _dereq_('./decorator');
BehaviourTree.InvertDecorator = _dereq_('./invert_decorator');
BehaviourTree.AlwaysFailDecorator = _dereq_('./always_fail_decorator');
BehaviourTree.AlwaysSucceedDecorator = _dereq_('./always_succeed_decorator');

module.exports = BehaviourTree;

},{"./always_fail_decorator":3,"./always_succeed_decorator":4,"./Behaviour_tree":5,"./branch_node":6,"./decorator":7,"./invert_decorator":9,"./node":10,"./priority":11,"./random":12,"./sequence":13,"./task":14}],9:[function(_dereq_,module,exports){
